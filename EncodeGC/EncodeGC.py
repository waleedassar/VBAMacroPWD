...
if argC != 2 and argC != 3:
    print "Usage: EncodeGC.py Value\r\n"
    print "Usage: EncodeGC.py Value <required length>\r\n"
    sys.exit(-1)
...
if argC == 3:
    ...
    if ReqLength < 16:
        print "Invalid input length, must be 16, 18, 20, and so on\r\n"
        sys.exit(-2)
    else:
        Seed = GetSeedX(GetIgnoredLengthGC(ReqLength))

GC = EncodeGC(Value,Seed)
print "GC: " + PrintHash(GC).upper()
print "Done"
